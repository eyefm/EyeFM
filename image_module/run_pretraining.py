...
def get_args():
    ...
    parser.add_argument('-c', '--config', default='cfgs/pretrain/pretraining.yaml', type=str, metavar='FILE',
    ...
    parser.add_argument('--out_domains', default='rgb-depth', type=str,
