...
class LlavaLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig, mm_vision_tower=None, mm_hidden_size=None):
        ...
        self.vision_tower_name = '/EyeFM/transfer_image_encoder'
        #print(config)
        #exit()
        
        config.mm_vision_tower = '/EyeFM/transfer_image_encoder'
    ...
    def initialize_vision_modules(self, vision_tower, mm_vision_select_layer,
        ...
        if "BiomedCLIP" in vision_tower:
            ...
            return self.initialize_vision_modules_from_multimae(vision_tower, mm_vision_select_layer,
                                pretrain_mm_mlp_adapter=None, tune_mm_mlp_adapter=False)

    
    #load our vision tower
    def initialize_vision_modules_from_multimae(self, vision_tower, mm_vision_select_layer,
                                  pretrain_mm_mlp_adapter=None, tune_mm_mlp_adapter=False):
...
#LlavaConfig.mm_vision_tower ="clip-vit-large-patch14"
